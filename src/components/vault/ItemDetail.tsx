...
import {
  ...
  Check, ArrowLeft, ShieldAlert, Clock, Hash
} from 'lucide-react';
import {
      ...
      <header className="p-6 md:px-10 md:py-8 border-b border-border/50 flex justify-between items-center bg-card/10 backdrop-blur-md sticky top-0 z-10 shrink-0">
        <div className="flex items-center gap-5 min-w-0">
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-3">
               <h2 className="text-2xl md:text-3xl font-extrabold truncate tracking-tight">{item.title}</h2>
        ...
        <div className="flex gap-2 shrink-0">
          <Button
            variant="ghost"
            size="icon"
            className={item.favorite ? "text-orange-500 hover:text-orange-600" : ""}
            ...
            >
              {item.totpSecret && (
                <div className="space-y-3">
                  ...
                  <div className="p-8 rounded-3xl bg-primary/5 border border-primary/20 flex flex-col md:flex-row items-center justify-between gap-6 group">
                    ...
                    <Button 
                      variant="secondary" 
                      className="h-12 px-6 rounded-2xl gap-2 font-bold transition-all hover:scale-105 active:scale-95" 
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {item.username && (
                  <div className="space-y-2 group">
                    ...
                    <div className="flex items-center justify-between p-4 rounded-2xl bg-secondary/20 border border-border group-hover:border-primary/20 transition-all">
                      <span className="font-mono text-lg truncate pr-4">{item.username}</span>
                      <Button variant="ghost" size="icon" onClick={() => copyToClipboard(item.username!, 'Username')} className="rounded-xl">
                ...
                {item.password && (
                  <div className="space-y-2 group">
                    ...
                    <div className="flex items-center justify-between p-4 rounded-2xl bg-secondary/20 border border-border group-hover:border-primary/20 transition-all">
                      <span className="font-mono text-lg tracking-[0.3em] opacity-50">••••••••••••</span>
                      <Button variant="ghost" size="icon" onClick={() => copyToClipboard(item.password!, 'Password')} className="rounded-xl">
                ...
                <div className="space-y-2 group">
                  ...
                  <div className="flex items-center justify-between p-4 rounded-2xl bg-secondary/20 border border-border group-hover:border-primary/20 transition-all">
                    ...
                    <div className="flex gap-1 shrink-0">
                      <Button variant="ghost" size="icon" onClick={() => copyToClipboard(item.url!, 'URL')} className="rounded-xl">
